...
// ─── Nav items matching the reference sidebar ─────────────────────────────────
const NAV_ITEMS = [
  {
...
export default function AppShell() {
  ...
  const displayName = user?.full_name || 'Vikram Rao';
  const displayEmail = user?.email || 'vikram@peoplepay360.io';
      ...
      <div className="shell__main">
        ...
        <header className="dash-navbar">
          ...
          <div className="dash-navbar__right">
            {/* Notification Bell */}
            <button className="dash-navbar__notif-btn" title="Notifications" aria-label="Notifications">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
